...
const HAS_SEEN_LANDING_KEY = 'sql-playground-has-seen-landing';

function App() {
  const [showLanding, setShowLanding] = useState(() => {
    const hasSeen = localStorage.getItem(HAS_SEEN_LANDING_KEY);
    return !hasSeen;
  });
  ...
  const handleGetStarted = () => {
    ...
    localStorage.setItem(HAS_SEEN_LANDING_KEY, 'true');
  };
